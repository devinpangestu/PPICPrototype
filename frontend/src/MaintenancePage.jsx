...
import onWorkImage from "./assets/images/workworkwork.png";
...
const MaintenancePage = () => {
  ...
  if (
    utils.redirectRole(userInfo.role.id, 2) ||
    utils.redirectRole(userInfo.role.id, 3) ||
    utils.redirectRole(userInfo.role.id, 4) ||
    utils.redirectRole(userInfo.role.id, 5) ||
    utils.redirectRole(userInfo.role.id, 6) ||
    utils.redirectRole(userInfo.role.id, 7) ||
    utils.redirectRole(userInfo.role.id, 8)
  ) {
    redirectTo = "/offers";
  }
  useEffect(() => {
      ...
      <body>
        <div id="article">
          <div id="imageContainer">
            <img id="maintenanceImage" src={onWorkImage} alt="workEmoji" />
          </div>
