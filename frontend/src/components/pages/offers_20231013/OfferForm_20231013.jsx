...
const OfferForm = (props) => {
  ...
  useEffect(() => {
    if (isEdit && !id) {
      utils.swal.Error({
        ...
        cbFn: () => {
          props.history.push("/offers_20231013");
          return;
        },
      });
      return;
  ...
  const onPriceChanged = () => {
    ...
    if (priceFreight) tempPrice = tempPrice.add(priceFreight);
    ...
    api.offers
      ...
      .then(function (response) {
        ...
        if (offer.handover_location_desc) {
          setField.handover_description = offer.handover_location;
        }
    ...
    <>
      ...
      >
        ...
        <Form.Item label={t("handover")}>
          ...
          <Form.Item label={t("handoverDescription")} labelCol={{ span: 7 }}>
            <Form.Item className="mb-2" name="handover_description">
              <Input placeholder={`${t("handoverDescription")} (${t("optional")})`} />
            </Form.Item>
          </Form.Item>
        </Form.Item>
        <Form.Item
        ...
        <Form.Item label={t("termsOfLoading")}>
          <Form.Item
            className="mb-0"
            name="terms_of_loading"
            rules={[
              {
                required: true,
                message: `${t("please")} ${t("select")} ${t("termsOfLoading")}`,
              },
            ]}
          >
            <Select
