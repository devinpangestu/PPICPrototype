    ...
    >
      <Form labelCol={{ span: 8 }} size="small">
        <Form.Item label={t("date")} className="mb-0">
          {values.date && <Input value={values.date} bordered={false} />}
        </Form.Item>
        <Form.Item label={t("week")} className="mb-0">
          {values.week && <Input value={values.week} bordered={false} />}
        </Form.Item>
        ...
        <Form.Item label={t("handoverDate")} className="mb-0">
          {values.handover_date && <Input value={values.handover_date} bordered={false} />}
        </Form.Item>
