...
import { SpinnerOverlay, TableNotFoundNotice } from "@/components";
...
import { SectionHeading, SyncOverlay } from "components";

const LogisticHome = (props) => {
        ...
        {offers.map((el) => {
          return (
            <Card
              ...
              onClick={() => {
                utils.openInNewTab(
                  `/logistic/offers/create?commodity_offer=${el.commodity_offer_id}`,
                );
              }}
            >
              <tr>
                  ...
                  return (
                    <Card
                      ...
                      onClick={() => {
                        ...
                        utils.openInNewTab(
                          `/logistic/offers/create?commodity_offer=${el.unique_id}`,
                        );
                      }}
                    >
                      <tr>
  ...
  return (
    <PageContainer title={"Dashboard"}>
      ...
      <DatePicker
        ...
        inputReadOnly={true}
        size="small"
        onChange={(dateM, dateStr) => {
          setYearFilter(dateStr);
        }}
        picker="year"
      />
        ...
        <Col xs={24}>
          {data && (
            <Table
              ...
              {...configs.TABLE_PAGINATION_DASHBOARD_SINGLEPAGE}
            />
          )}
