...
dotenv.config();
const sendEmailNotificationSupplierProcEdit = async (subject, text, target) => {
  try {
    console.log("target", subject, text, target);
...
export default sendEmailNotificationSupplierProcEdit;
